function [RMS_position, RMS_orientation, NEES_pose, NEES_orientation] = notREKF_plot_rms_nees( estimation_results, data, do_vis )
% plot rms and nees for notR-EKF
...
RMS_orientation=[];
for i = T
    position = estimation_results{i}.position;%估计的坐标
    ap = data.poses.position(:,i);%原始的坐标
